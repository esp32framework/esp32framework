...
use esp32_nimble::{
    ...
    BLEAdvertisementData, BLEAdvertising, BLEDevice,
};

fn set_advertisement_services(
    ble_advertising: &Mutex<BLEAdvertising>,
    service_id: &Vec<u16>,
...
fn loop_services(
    ble_advertising: &Mutex<BLEAdvertising>,
    advertisement: &mut BLEAdvertisementData,
    services: &[u16],
    data: &Vec<[u8; 2]>,
    i: usize,
) {
