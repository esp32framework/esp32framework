use crate::{ble::{utils::{ble_standard_uuids::{StandarCharacteristicId, StandarServiceId}, Characteristic, Service}, BleId, BleServer}, wifi::http::{Http, HttpClient, HttpHeader, HttpHeaderType}, Microcontroller};
