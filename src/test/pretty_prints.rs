...
pub fn print_executing_test(test_number: u8, test_name: &str){
    println!("{} ...", &(ansi_format!(BLUE_ANSI, "Executing ") + &get_test_id(BLUE_ANSI, test_number, test_name)))
}
...
pub fn print_failing_test(test_number: u8, test_name: &str, reason: &str){
    println!("{}", get_test_id(BLUE_ANSI, test_number, test_name) + &ansi_format!(RED_ANSI, "failed, returned: {reason}"))
}
...
pub fn print_passing_test(test_number: u8, test_name: &str){
    println!("{}", get_test_id(BLUE_ANSI, test_number, test_name) + &ansi_format!(GREEN_ANSI, "was successfull"))
}
...
pub fn print_not_executed_test(test_number: u8, test_name: &str, reason: &str){
    println!("{}", get_test_id(BLUE_ANSI, test_number, test_name) + &ansi_format!(YELLOW_ANSI, "not executed due to: {reason}"))
}
